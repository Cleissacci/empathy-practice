...
window.COURSE = (function () {
  ...
  const slides = [
    ...
    { id: 'm1_tabs', type: 'tabs', section: 'Module 1', gate: true,
      ...
      tabs: [
        { label: 'Sympathy', img: 'assets/images/sympathy.png', body: 'Noticing another person\u2019s pain from a distance — \u201cI\u2019m sorry that happened to you.\u201d It acknowledges, but stays outside.' },
        { label: 'Empathy', img: 'assets/images/empathy.png', body: 'Stepping closer: sensing what another person feels, and understanding why. It is the heart of this course — and it is learnable.' },
        { label: 'Compassion', img: 'assets/images/compassion.png', body: 'Empathy plus a third movement — the wish to help, and the willingness to act on it. Empathy without compassion can exhaust us; compassion without empathy can miss the mark.' },
      ] },
    ...
    { id: 'm4_tabs', type: 'tabs', section: 'Module 4', gate: true,
      ...
      tabs: [
        { label: 'Reflect', img: 'assets/images/reflect.png', body: 'Name what you notice — \u201cIt sounds like that landed hard.\u201d Reflecting shows the other person their experience registered with you.' },
        { label: 'Paraphrase', img: 'assets/images/paraphrase.png', body: 'Return the content in your own words, so the speaker hears that they were genuinely received — not just heard.' },
        { label: 'Hold silence', img: 'assets/images/hold_silence.png', body: 'Resist the urge to fill the space. Silence lets the other person reach the thing under the first thing they said.' },
      ] },
